...
Cross-sectional momentum backtesting across equities and commodities, and a Dual Momentum strategy engine computing Sharpe, Sortino, Calmar, max drawdown, and CAGR.
""")
    with col2:
        st.markdown("""
**🌍 Macro Research**
